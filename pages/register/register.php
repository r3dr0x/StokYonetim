          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h6 class="font-weight-light">Devam etmek için kayıt olun.</h6>
<form class="pt-3" method="POST" id="registerForm">
        <div class="form-group">
        <input type="name" class="form-control form-control-lg" name="name" placeholder="Ad">
    </div>
        <div class="form-group">
        <input type="surname" class="form-control form-control-lg" name="surname" placeholder="Soyad">
    </div>
    <div class="form-group">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (event) {
        ...
        fetch('../../includes/registercontrol.php', {
            method: 'POST',
            headers: {
